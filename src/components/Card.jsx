export default function Card(){
    ...
    return(
        <>
            <div className="contain w-[100%] m-auto">
            <div className="all-card flex w-full flex-wrap justify-evenly">
                {image.map((item)=>(
                    <>
                        
                            <div className="card w-[90%] h-[450px] xl:w-[300px] xl:h-[420px] md:w-[31.5%] md:h-[400px] bg-white p-3 shadow-xl m-2 rounded-xl ">
